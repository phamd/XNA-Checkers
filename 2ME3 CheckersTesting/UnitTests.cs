...
namespace _2ME3_CheckersTest
{
    ...
    public class UnitTests
    {
        ...
        public void BoardLegalMovesTest_MidgameSetup()
        {
            ...
            String[][] expectedValidMoves = new String[64][] { new String[] { "illegal", "1,1", "illegal", "illegal" }, new String[] { null }, new String[] { "illegal", "illegal", "illegal", "illegal" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "1,5", "illegal" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "2,2", "illegal" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "illegal", "illegal" }, new String[] { "1,1", "3,1", "3,-99", "1,-99" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "illegal", "illegal" }, new String[] { null }, new String[] { "illegal", "3,7", "illegal", "illegal" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "4,4", "5,1", "2,2" }, new String[] { null }, new String[] { "illegal", "4,6", "illegal", "illegal" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "illegal", "illegal" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "7,1", "3,1" }, new String[] { null }, new String[] { "illegal", "illegal", "7,3", "4,4" }, new String[] { null }, new String[] { "4,-99", "6,-99", "illegal", "4,6" }, new String[] { "5,1", "7,1", "illegal", "illegal" }, new String[] { null }, new String[] { "4,4", "7,3", "illegal", "illegal" }, new String[] { null }, new String[] { "4,6", "illegal", "illegal", "illegal" }, new String[] { null }, new String[] { "illegal", "7,7", "illegal", "4,4" }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { null }, new String[] { "illegal", "illegal", "illegal", "illegal" }, new String[] { null }, new String[] { null } };
            BoardLegalMovesTest(boardSetup, expectedValidMoves);
        }
                    ...
                    for (int row = 0; row < 8; row++)
                    {
                        try
                        {
                            ...
                            for (int i = 0; i < 4; i++)
                            {
                                ...
                                if (actualResult[i].Split(',')[0] == "-99") actualResult[i] = "illegal";
                                Console.WriteLine("("+col+", "+row +"): "+ expectedResult[col * 8 + row][i].ToString() + " : " + actualResult[i]);
